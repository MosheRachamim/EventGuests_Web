...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.totalApproved = "סך הכל אישרו הגעה : " + this.tableStatsResult.overallStats[0].approved;
    this.totalArrived = "סך הכל הגיעו בפועל : " + this.tableStatsResult.overallStats[0].arrived;
    this.totalPercentage = "אחוז הגעה : " + Math.round(this.tableStatsResult.overallStats[0].percentage) + "%";
